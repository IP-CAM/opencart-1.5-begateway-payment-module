...
class ControllerPaymentBegateway extends Controller {
  ...
  public function index() {
    ...
    if (isset($this->request->post['begateway_encryptionkey'])) {
      $this->data['begateway_encryptionkey'] = $this->request->post['begateway_encryptionkey'];
    } else {
      $this->data['begateway_encryptionkey'] = $this->config->get('begateway_encryptionkey');
    }
    ...
    if (isset($this->request->post['begateway_test_mode'])) {
      $this->data['begateway_test_mode'] = $this->request->post['begateway_test_mode'];
    } else {
      $this->data['begateway_test_mode'] = $this->config->get('begateway_test_mode');
    }
